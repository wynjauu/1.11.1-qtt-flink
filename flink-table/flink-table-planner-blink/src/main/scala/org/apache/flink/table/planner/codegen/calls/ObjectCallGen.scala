...
/**
 * Inverts the Object value of a [[CallGenerator]] result.
 */
class ObjectCallGen(callGenerator: CallGenerator) extends CallGenerator {
  ...
  override def generate(
    ...
    assert(returnType.isInstanceOf[Object])
