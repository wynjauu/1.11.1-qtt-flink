...
/**
 * @author liufangliang
 * @date 2020/6/10 8:10 PM
 */

public class ProtobufFieldConverterUtil {
	/**
	 * initialize  An protobuf schema converter (as a {@link ProtobufFieldConverter} )
	 * for the {@link MessageVersion } defined by customer.
	 *
	 * @return Subclass of {@link ProtobufFieldConverter}
	 */
	public static ProtobufFieldConverter genericFieldConverter(String messageVersion, RowTypeInfo rowTypeInfo, boolean ignoreParseErrors) {
