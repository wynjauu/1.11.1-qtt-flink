...
public class ProtoBufFormatFactory implements DeserializationFormatFactory, SerializationFormatFactory {
	...
	public DecodingFormat<DeserializationSchema<RowData>> createDecodingFormat(
		...
		String messageVersion = formatOptions.get(QUTOUTIAO_MESSAGE_VERSION);
		...
		return new DecodingFormat<DeserializationSchema<RowData>>() {
			...
			public DeserializationSchema<RowData> createRuntimeDecoder(
				...
				final TypeInformation<RowData> rowDataTypeInfo = (TypeInformation<RowData>) context.createTypeInformation(producedDataType);
	...
	public Set<ConfigOption<?>> requiredOptions() {
		...
		options.add(QUTOUTIAO_MESSAGE_VERSION);
		return options;
	}
	...
	static void validateFormatOptions(ReadableConfig tableOptions) {
		String messageVersion = tableOptions.get(QUTOUTIAO_MESSAGE_VERSION);
