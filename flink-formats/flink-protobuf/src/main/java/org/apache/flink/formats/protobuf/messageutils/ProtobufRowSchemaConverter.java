...
public final class ProtobufRowSchemaConverter implements Serializable {
	...
	private ProtobufRowSchemaConverter(String messageVersion, RowTypeInfo rowTypeInfo, Boolean ignoreParseErrors) {
		this.messageVersion = messageVersion;
		this.rowTypeInfo = rowTypeInfo;
		this.ignoreParseErrors = ignoreParseErrors;
		this.fieldConverter = ProtobufFieldConverterUtil.genericFieldConverter(messageVersion, rowTypeInfo, ignoreParseErrors);
	}
	...
	public static class Builder {
		...
		public ProtobufRowSchemaConverter build() {
			ProtobufRowSchemaConverter converter = new ProtobufRowSchemaConverter(messageVersion, rowTypeInfo, ignoreParseErrors);
			return converter;
		}
