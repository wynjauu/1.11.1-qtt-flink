...
public class KafkaValidator extends ConnectorDescriptorValidator {
	...
	public static final String DELAY_OPEN = "delay.open";
	public static final String DELAY_SECOND = "delay.second";
	public static final String DELAY_EVENTTIME_FIELD_INDEX = "delay.eventtime.field.index";
	public static final String DELAY_CACHE_SIZE = "delay.cache.size";
	public static final String KEYBY_INDEX = "keyby.index";
	public static final String KEYBY_FIELD = "keyby.field";
	public static final int DEFAULT_DELAY_CACHE_SIZE = Integer.MAX_VALUE;
