...
import static org.apache.flink.streaming.connectors.kafka.table.KafkaSinkSemantic.*;
...
public class KafkaOptions {
    ...
    public static final ConfigOption<Boolean> DELAY_OPEN =
            ConfigOptions.key("delay.open")
                    .booleanType()
                    .defaultValue(false)
                    .withDescription("wheather open delay consumed.");
    public static final ConfigOption<Integer> DELAY_SECOND =
            ConfigOptions.key("delay.second")
                    .intType()
                    .noDefaultValue()
                    .withDescription("how many seconds to delay.");
    public static final ConfigOption<Integer> DELAY_EVENTTIME_FIELD_INDEX =
            ConfigOptions.key("delay.eventtime.field.index")
                    .intType()
                    .noDefaultValue()
                    .withDescription("delay eventtime field index");
    public static final ConfigOption<String> DELAY_CACHE_SIZE =
            ConfigOptions.key("delay.cache.size")
                    .stringType()
                    .noDefaultValue()
                    .withDescription("the size to cache record when delay open.");
    public static final ConfigOption<Integer> PARALLELISM =
            ConfigOptions.key("parallelism")
                    .intType()
                    .noDefaultValue()
                    .withDescription("the parallelism of kafka.");
