 ...
 * #createKafkaProducer(String, Properties, SerializationSchema, Optional, KafkaSinkSemantic)}}.
 */
@Internal
public abstract class KafkaDynamicSinkBase implements DynamicTableSink {
    ...
    public int hashCode() {
        return Objects.hash(
                consumedDataType, topic, properties, encodingFormat, partitioner, semantic);
    }
}
