            ...
            createTable =
                    String.format(
                            "create table kafka (\n"
                                    ...
                                    + "  %s\n"
                                    + ")",
                            factoryIdentifier(), topic, bootstraps, groupId, formatOptions());
        } else {
            createTable =
                    String.format(
                            "create table kafka (\n"
                                    ...
                                    + "  %s\n"
                                    + ")",
                            kafkaVersion(), topic, bootstraps, groupId, formatOptions());
        }
        ...
        currencies.forEach(
                currency ->
                        TableEnvUtil.execInsertSqlAndWaitResult(
                                tEnv, String.format(insertTemp, currency.toLowerCase(), currency)));
