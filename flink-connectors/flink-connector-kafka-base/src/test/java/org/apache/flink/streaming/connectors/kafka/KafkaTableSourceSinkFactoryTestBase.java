...
public abstract class KafkaTableSourceSinkFactoryTestBase extends TestLogger {
    ...
    static {
        KAFKA_PROPERTIES.setProperty(DELAY_OPEN, String.valueOf(false));
        KAFKA_PROPERTIES.setProperty(DELAY_SECOND, String.valueOf(0L));
        KAFKA_PROPERTIES.setProperty(DELAY_EVENTTIME_FIELD_INDEX, String.valueOf(0));
        KAFKA_PROPERTIES.setProperty(DELAY_CACHE_SIZE, String.valueOf(DEFAULT_DELAY_CACHE_SIZE));
        KAFKA_PROPERTIES.setProperty(PARALLELISM, String.valueOf(0));
        KAFKA_PROPERTIES.setProperty(KEYBY_INDEX, String.valueOf(-1));
        KAFKA_PROPERTIES.setProperty(KEYBY_FIELD, "");
