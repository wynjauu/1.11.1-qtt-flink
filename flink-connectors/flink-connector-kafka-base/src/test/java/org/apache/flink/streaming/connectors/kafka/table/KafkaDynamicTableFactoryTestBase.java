...
public abstract class KafkaDynamicTableFactoryTestBase extends TestLogger {
    ...
    public void testTableSource() {
        ...
        ObjectIdentifier objectIdentifier = ObjectIdentifier.of("default", "default", "scanTable");
    ...
    public void testInvalidSinkSemantic() {
        ...
        thrown.expect(
                containsCause(
                        new ValidationException(
                                "Unsupported value 'xyz' for 'sink.semantic'. Supported values are ['at-least-once', 'exactly-once', 'none'].")));
        FactoryUtil.createTableSink(
                null,
                objectIdentifier,
                sinkTable,
