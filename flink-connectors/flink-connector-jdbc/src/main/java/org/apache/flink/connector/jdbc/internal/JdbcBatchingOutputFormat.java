...
public class JdbcBatchingOutputFormat<
    ...
    private transient long lastFlushMs = 0L;
    ...
    public long getLastFlushInterval() {
        return System.currentTimeMillis() - lastFlushMs;
    }
        ...
        try {
            ...
            for (int i = 0; i <= executionOptions.getMaxRetries(); i++) {
                try {
                    ...
                    LOG.warn("JDBC executeBatch error, retry times = {}", i, e);
            ...
            LOG.info(
                    "Jdbc sinker, record size [{}], use [{}]ms",
                    tmpBatchCount,
