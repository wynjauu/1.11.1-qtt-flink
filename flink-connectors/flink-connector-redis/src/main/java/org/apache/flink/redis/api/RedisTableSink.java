...
public class RedisTableSink implements UpsertStreamTableSink<Row> {
	...
	public RedisTableSink(String redisIp, int redisPort, String redisPassword, String redisValueType, TableSchema tableSchema) {
	...
	public TypeInformation<Row> getRecordType() {
		return (TypeInformation<Row>)TypeConversions.fromDataTypeToLegacyInfo(tableSchema.toRowDataType());
	}
