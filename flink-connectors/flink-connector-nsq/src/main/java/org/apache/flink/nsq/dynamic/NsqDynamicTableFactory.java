...
/**
 * @author: zhushang
 * @create: 2020-08-27 16:28
 **/

public class NsqDynamicTableFactory implements DynamicTableSinkFactory {
	public static final ConfigOption<String> NSQ_IP = ConfigOptions.key("ip")
		.stringType()
		.noDefaultValue()
		.withDescription("the nsq's connect address.");
	public static final ConfigOption<Integer> NSQ_PORT = ConfigOptions.key("port")
		.intType()
		.noDefaultValue()
		.withDescription("the nsq's connect port.");
	public static final ConfigOption<String> NSQ_TOPIC = ConfigOptions.key("topic")
		.stringType()
		.noDefaultValue()
